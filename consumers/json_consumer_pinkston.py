...
#####################################
# New custom process_message function
#####################################
...
def process_message(message: str) -> None:
    ...
    try:
        ...
        # Combine message + author as a single count
        total_messages += 1
        window_messages += 1

        # Log the processed message
        logger.info(f"Consumed message: '{msg_text}' by {author}")
        print(f"Consumed message: '{msg_text}' by {author}")
